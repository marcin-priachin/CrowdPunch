    ...
    public static class NavigationGeometry
    {
        ...
        public static bool Intersects(float2 a,float2 b,float2 min,float2 max)
        {
            ...
            for(int axis=0;axis<2;axis++)
            {
                ...
                else { float t0=(min[axis]-a[axis])/d[axis],t1=(max[axis]-a[axis])/d[axis];
        ...
        {
            switch(direction) { case 0:return new int2(1,0);case 1:return new int2(0,1);case 2:return new int2(-1,0);case 3:return new int2(0,-1);
                case 4:return new int2(1,1);case 5:return new int2(-1,1);case 6:return new int2(-1,-1);default:return new int2(1,-1); }
        }
