...
namespace CrowdPunch.Configuration
{
    ...
    public sealed class BossEncounterSettings : ScriptableObject
    {
        ...
        public float headHeight = .5f, handHeight = .4f;
        ...
        [Min(0)] public float shieldOffset = 1.2f;
        [Min(1)] public float shieldForward = 3;
        ...
        [Min(0)] public float playerDamage = 15, playerKnockback = 12, playerInvulnerability = .8f;
