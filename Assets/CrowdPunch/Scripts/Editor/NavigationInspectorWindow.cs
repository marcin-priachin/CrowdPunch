...
namespace CrowdPunch.Editor
{
    public sealed class NavigationInspectorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField($"Navigation CPU {d.Milliseconds:F3} ms (last fixed update)");
        ...
        {
            if(!draw)return;var world=World.DefaultGameObjectInjectionWorld;if(world==null || !world.IsCreated)return;
