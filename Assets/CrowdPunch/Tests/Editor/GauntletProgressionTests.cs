...
namespace CrowdPunch.Tests
{
    public sealed class GauntletProgressionTests
    {
        ...
        [Test]
        public void Loop002_ActiveSequenceAndBuildSettingsContainTwelveOrderedLevels()
        {
